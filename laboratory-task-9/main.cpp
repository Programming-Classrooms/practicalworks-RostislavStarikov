/*
    —троки текстового файла input.txt состо€т из слов, разделенных одним  или несколькими пробелами.
    ѕеред первым, а также после последнего слова  строки пробелы могут отсутствовать. 
    “ребуетс€ найти слова максимальной и  минимальной длины и помен€ть их местами.
    ≈сли таких слов несколько Ц брать первые.
*/
